class Alimentos:
    def __init__(self, Descricao, Categorias_ID_Categoria, Categoria, lista_ingredientes, ID_Alimento=None):
...
class Cardapio:
    def __init__(self, Descricao, ID_Cardapio=None):
